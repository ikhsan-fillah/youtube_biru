    ...
    <div class="flex flex-col justify-center w-full items-center  h-[100vh]">
        <div class="mx-auto flex w-full flex-col justify-center px-5 pt-0 md:h-[unset] md:max-w-[50%] lg:h-[100vh] min-h-[100vh] lg:max-w-[50%] lg:px-6">
            <div class="bg-blue-500 rounded-lg mb-auto p-8 my-auto flex flex-col md:mt-[70px] w-[350px] max-w-[450px] mx-auto md:max-w-[450px] lg:mt-[110px] lg:max-w-[450px]">
                <p class="text-lg text-[32px] font-bold text-zinc-950 dark:text-white">Login</p>
                <p class="mb-2.5 mt-2.5 font-normal text-zinc-950 dark:text-zinc-400">Masukan email dan password untuk login</p>
                <div class="mt-3">
                    <form action="loginProcess.php" method="POST" class="pb-2">
                        <input type="hidden" name="provider" value="google">
                        <button class="bg-white inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 w-full text-zinc-950 py-6 dark:text-white" type="submit">
                            <span class="mr-2">
                    ...
                    <form action="loginProcess.php" method="POST" class="mb-4">
                        <div class="grid gap-2">
                            <div class="grid gap-1">
                                ...
                                <p><a href="#" class="font-medium text-zinc-950 dark:text-white text-sm text-right">Lupa password?</a></p>
                            </div>
                            <button class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-primary-foreground hover:bg-primary/90 mt-2 flex h-[unset] w-full items-center justify-center rounded-lg px-4 py-4 text-sm font-medium" type="submit">Login</button>
                        </div>
                    </form>
                    <p>Belum punya akun? <a href="signup.php" class="font-medium text-zinc-950 dark:text-white text-sm">Daftar sekarang</a></p>
                </div>
            </div>
        </div>
    </div>
